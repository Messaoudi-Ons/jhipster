...
import com.myapp.mycompany.repository.CommandeRepository;
import com.myapp.mycompany.service.CommandeService;
import com.myapp.mycompany.service.dto.CommandeDTO;
import com.myapp.mycompany.service.mapper.CommandeMapper;
...
public class CommandeResourceIT {
    ...
    public void createCommande() throws Exception {
        ...
        assertThat(testCommande.getCommande()).isEqualTo(DEFAULT_COMMANDE);
    ...
    public void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc.perform(get("/api/commandes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].commande").value(hasItem(DEFAULT_COMMANDE)))
    ...
    public void getCommande() throws Exception {
        ...
        restCommandeMockMvc.perform(get("/api/commandes/{id}", commande.getId()))
            ...
            .andExpect(jsonPath("$.commande").value(DEFAULT_COMMANDE))
    ...
    public void updateCommande() throws Exception {
        ...
        Commande testCommande = commandeList.get(commandeList.size() - 1);
        assertThat(testCommande.getCommande()).isEqualTo(UPDATED_COMMANDE);
